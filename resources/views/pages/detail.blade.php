                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <div class="members my-2">
                          <img src="{{url("frontend/images/trip-icon-1.png")}}" alt="" class="members-image mr-1">  
                          <img src="{{url("frontend/images/trip-icon-2.png")}}" alt="" class="members-image mr-1">  
                          <img src="{{url("frontend/images/trip-icon-3.png")}}" alt="" class="members-image mr-1">  
                          <img src="{{url("frontend/images/trip-icon-4.png")}}" alt="" class="members-image mr-1">  
                          <img src="{{url("frontend/images/trip-icon-6.png")}}" alt="" class="members-image mr-1">  
                        </div>
                        <hr>
