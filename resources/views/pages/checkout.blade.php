                        ...
                        <div class="attendee">
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="tetx-center">
                                                No visitor
                                            </td>
                                        </tr>
                                    @endforelse
                        ...
                        <div class="member mt-3">
                            ...
                            <form action="{{ route('checkout-create', $item->id)}}" class="form-inline" method="POST">
                                ...
                                <label for="username" class="sr-only">Name</label>
                                    <input name="username" type="text" class="form-control mb-2 mr-sm-2" id="username" placeholder="Username">
                                <label for="nationality" class="sr-only">Nationality</label>
                                    <input name="nationality" type="text" class="form-control mb-2 mr-sm-2" style="width: 50px" id="nationality" placeholder="Nationality">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <input type="text" style="width: 120px" class="form-inline datepicker" name="doe_passport" id="doe_passport" placeholder="DOE Passport">
                                </div>
